...
namespace Totem.Sword3D
{
    public class TotemDemoManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            totemDB.OnSwordsLoaded.AddListener(OnSwordsLoaded);
        ...
        private void OnUserProfileLoaded(string publicKey)
        {
            ...
            totemDB.GetUserSwords(_publicKey);
        }
        ...
        private void OnSwordsLoaded(List<TotemSword> swords)
        {
            _userSwords = swords;
        ...
        public void ShowSwordRecords()
        {
            GetLegacyRecords(firstSword, (records) =>
            {
                UIAssetLegacyRecordsList.Instance.BuildList(firstSword, records);
                UILoadingScreen.Instance.Hide();
            });
        }
        #endregion
        ...
        /*public void AddLegacyToFirstSword(int data)
        {
            AddLegacyRecord(firstSword, data);
        }*/
        ...
        private void BuildSwordList()
        {
            assetList.BuildList(_userSwords.Cast<ITotemAsset>().ToList());
            UISwordsList.Instance.BuildSwordsList(_userSwords.Cast<ITotemAsset>().ToList(), _userSwords);
        }
